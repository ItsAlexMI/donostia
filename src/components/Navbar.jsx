      ...
      <div className="flex w-full items-center justify-between">
        <div className="navbar-end items-center justify-between max-md:w-full">
          <Link
            ...
            to="/"
          >
            <PublicIcon className='text-green-300' style={{fontSize: '40px' }}/>
            Donostia
          </Link>
      ...
      >
        <ul className="menu md:menu-horizontal bg-gray-50 gap-4 p-0 text-base text-gray-700">
          <li>
            ...
            >
              <PublicIcon className='text-indigo-400' />
              Hasi
            </Link>
          </li>
          <li>
            ...
            >
                <InstagramIcon className='text-violet-400'/>
              _moremnb_
            </Link>
          </li>
          <li>
            <Link
              ...
              className="text-md px-3 py-2 rounded-md hover:rounded-full bg-gray-50 text-gray-700 hover:bg-gray-200 hover:text-gray-900"
            >
              <InstagramIcon className='text-purple-400'/>
              sharys_paolab
            </Link>
          </li>
          <li>
            <Link
              ...
              className="text-md px-3 py-2 rounded-md hover:rounded-full bg-gray-50 text-gray-700 hover:bg-gray-200 hover:text-gray-900"
            >
              <InstagramIcon className='text-fuchsia-400'/>
              radoksiii
            </Link>
          </li>
        </ul>
